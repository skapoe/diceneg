...
@click.option('--gen_train_num', default=1111)
@click.option('--gen_valid_num', default=24)
@click.option('--gen_test_num', default=100)
...
def main(dataset, seed, gen_train_num, gen_valid_num, gen_test_num, max_ans_num, reindex, gen_train, gen_valid, gen_test, gen_id, save_name, index_only,gen_all):
